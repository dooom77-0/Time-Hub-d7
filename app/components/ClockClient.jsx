...
export default function ClockClient() {
    ...
    return (
        ...
        >
            ...
            <h1 className="text-2xl font-bold mb-10">الساعة الحالية</h1>

            <h1 className="text-4xl font-bold text-shadow-lg">{time.toLocaleTimeString("en-US", { hour12: true })}</h1>

            <h2>
                <Clock value={time} size={150} className="mt-10" />
            </h2>
        </div>
        </motion.div>
